                  ...
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                          ...
                          >
                            ...
                            {image.isPrimary ? (
                              ...
                              <Button
                                ...
                                size="sm"
                                variant="secondary"
                                className="absolute bottom-2 left-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity h-8 text-xs shadow-md"
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">
                        Upload at least 3 images total (max 10). First image
